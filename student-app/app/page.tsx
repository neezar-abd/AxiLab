        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm"
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-gray-500 text-center">
              Demo account: <span className="font-medium text-gray-700">siswa@example.com</span> / <span className="font-medium text-gray-700">password123</span>
            </p>
          </div>
        </div>
